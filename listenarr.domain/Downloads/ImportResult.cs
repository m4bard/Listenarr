    ...
    public class ImportResult
    {
        ...
        public static ImportResult Exception(Exception exception, string sourcePath = "")
        {
            return new ImportResult
            {
                ...
                SourcePath = sourcePath,
                // Message keeps the exception text because it is what the log line and the
                // job log entry read. It is no longer what an external-facing surface reads:
                // FailureClass is what History renders (issue #975).
