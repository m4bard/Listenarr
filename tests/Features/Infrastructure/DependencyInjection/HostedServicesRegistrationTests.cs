...
namespace Listenarr.Tests.Features.Infrastructure.DependencyInjection
{
    public class HostedServicesRegistrationTests
    {
        ...
        public void AddListenarrHostedServices_RegistersHostedServicesAndSingletons()
        {
            ...
            Assert.Equal(
                [
                    typeof(AuthorCacheHousekeeper),
                    typeof(SeriesCacheHousekeeper),
                    typeof(FileMutationJournalHousekeeper),
                    typeof(CompatibilityFilePublicationJournalHousekeeper),
                    typeof(MoveJobHousekeeper)
                ],
                services
