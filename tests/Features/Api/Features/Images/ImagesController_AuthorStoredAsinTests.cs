...
namespace Listenarr.Tests.Features.Api.Features.Images
{
    public class ImagesController_AuthorStoredAsinTests
    {
        ...
        public async Task GetImage_UsesStoredAuthorAsin_FromRepository_ToCallAudnexus_GetAuthor()
        {
            ...
            var controller = new ImagesController(mockImageCache.Object, Mock.Of<IAudiobookMetadataService>(), audibleMock.Object, audnexusMock.Object, mockRepo.Object, Mock.Of<ILogger<ImagesController>>(), mockPathService.Object, new LocalFileSystem());
