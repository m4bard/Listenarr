...
/// <summary>
/// The ISBN endpoint is where a person meets the lookup service, and the lookup service tells
/// "no such ISBN" apart from "nobody answered". A person is owed the same distinction, as a
/// status code rather than as a stack trace.
/// </summary>
[Trait("Area", "Metadata")]
