...
### Added
- **Expanded language filter for Add New searches (issue #432):** Added Swedish, Norwegian, Danish, Finnish, Dutch, Portuguese, Japanese, Chinese, Czech, Turkish, Hindi, Korean, Arabic, and Greek as selectable language filters on the Add New page. Also expanded the MAM search result language parser to recognize these same languages from ISO 639 codes.
